    ...
    <form method="post" className="auth-form register-form">
      ...
      <div className="toggle-buttons">
        ...
        {selectedType === "individual" ? (
          ...
          <input type="text" name="org_name" placeholder="Organization name" id="org-name" />
        )}
        <input type="email" name="email" placeholder="abc@email.com" required/>
        <input type="password" name="password" placeholder="Your password" required/>
        <input type="password" name="confirm_password" placeholder="Confirm password" required/>
        <button type="submit" className="primary-btn">SIGN UP <span className="arrow">➜</span></button>
    </form>
  </div>
    );
  };
